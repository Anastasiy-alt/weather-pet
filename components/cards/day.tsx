...
const iconDescriptions: Record<string, string> = {
    'clear-day': 'Солнце светит вовсю — самое время выйти на улицу',
    'clear-night': 'Звёздное небо, луна на месте — отличная ночь для прогулки',
    'cloudy': 'Облака затянули небо, но дождя пока нет',
    'fog': 'Туман такой, что соседний дом уже загадка',
    'hail': 'Град идёт — лучше не выходить без шапки',
    'partly-cloudy-day': 'Солнце и облака делят небо поровну',
    ...
    'showers-day': 'Кратковременные дожди днём — зонт не помешает',
    ...
    'snow-showers-night': 'Ночью снег то идёт, то останавливается',
    ...
    'ice': 'Гололёд — ступай осторожно, каждый шаг под контролем',
}
