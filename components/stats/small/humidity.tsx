...
const HUMIDITY_LEVELS = [
    {max: 20, label: 'Очень сухо', description: 'Губы трескаются, статика везде'},
    {max: 30, label: 'Сухо', description: 'Кожа просит увлажнения'},
    {max: 40, label: 'Слегка сухо', description: 'Терпимо, но увлажнитель не помешает'},
    {max: 60, label: 'Комфортно', description: 'Самое то — дышится легко'},
    {max: 70, label: 'Нормально', description: 'Чуть влажновато, но жить можно'},
    {max: 80, label: 'Влажно', description: 'Волосы живут своей жизнью'},
    {max: 90, label: 'Очень влажно', description: 'Липко и душно, как в бане'},
    {max: 100, label: 'Невыносимо', description: 'Воздух как мокрое полотенце'},
] as const
