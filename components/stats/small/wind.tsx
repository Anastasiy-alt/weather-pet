...
import {getWindDirection, convertWindSpeed} from '@/lib/weatherUtils'
...
const WIND_LEVELS = [
    {max: 1, description: 'Идеально для велосипеда — ничто не мешает'},
    {max: 3, description: 'Ветер есть, но ведёт себя прилично'},
    {max: 5, description: 'Свежо и приятно — гулять одно удовольствие'},
    {max: 8, description: 'Ветер уже мнения имеет — и активно его высказывает'},
    {max: 12, description: 'На велосипеде в одну сторону легко, в другую — уже работа'},
    {max: 17, description: 'Ветер решил что он тут главный. Не спорь'},
    {max: Infinity, description: 'Ветер выиграл. Оставайся дома'},
] as const
